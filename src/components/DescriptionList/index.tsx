...
type DescriptionListProps = {
  heading?: string;
  listData: {id: string; image?: ImageProps['source']; text: string}[];
...
const DescriptionListComp = ({
  item,
  listTextStyle,
  listContainerStyle,
  imageStyle,
}: {
  item: {id: string; image?: ImageProps['source']; text: string};
  listTextStyle?: TextStyle;
  listContainerStyle?: ViewStyle;
  imageStyle?: ImageProps['style'];
}) => (
  ...
  <View style={[styles.centredItem, listContainerStyle]}>
    <CustomImage
      source={item?.image || Images.CircleCheck}
